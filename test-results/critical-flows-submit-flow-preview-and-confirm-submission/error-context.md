...
- Location: e2e\critical-flows.spec.ts:128:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://127.0.0.1:4173/submit
Call log:
  - navigating to "http://127.0.0.1:4173/submit", waiting until "load"
